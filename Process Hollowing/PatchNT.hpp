...
bool NtManageHotPatch32(HANDLE hProcess) {
...
bool NtManageHotPatch64(HANDLE hProcess) {
    HMODULE hNtdll = GetModuleHandleA("ntdll");
    if (!hNtdll) {
        return false;
    }
...
bool ZwQueryVirtualMemory(HANDLE hProcess, LPVOID module_ptr) {
#ifndef _WIN64
    return false;
#else
    HMODULE hNtdll = GetModuleHandleA("ntdll");
    ...
    BYTE func_patch[] = {
        0x49, 0x83, 0xF8, 0x0E,
        0x75, 0x22,
        0x48, 0x3B, 0x15, 0x0B, 0x00, 0x00, 0x00,
        0x75, 0x19,
        0xB8, 0xBB, 0x00, 0x00, 0xC0,
        0xC3
    };
